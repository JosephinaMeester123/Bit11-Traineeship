...
panel.fill<-function(x,y,mychr,CBSsegments){
  ...
  diagnosticBand <- read.csv("C:/Users/jeann/Desktop/CBS/diagnosticBand.b37.csv",header=TRUE)
  cytoBand <- read.csv("C:/Users/jeann/Desktop/CBS/cytoBand_hg38.csv",header=TRUE)
...
bin_data <- read.table("C:/Users/jeann/Desktop/CBS/106282.count.autosomal.norm",as.is=T,header=F,sep=" ")
names(bin_data)[1:7] <- list("CHR", "BIN.START", "BIN.END", "COUNT", "TOTALCOUNTSAMPLE", "TOTALCOUNTALL", "NORM_COUNT")
...
ref_data <- read.table("C:/Users/jeann/Desktop/CBS/referenceNormals.stats.binned_norm.csv",as.is=T,header=F,sep=",")
