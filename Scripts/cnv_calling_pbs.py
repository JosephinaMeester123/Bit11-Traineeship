...
# example:
# python /home/jmeester/Internship/Scripts/cnv_calling_pbs.py /home/jmeester/Internship/countfiles/ /home/jmeester/Internship/CNV/ josephina.meester@uantwerpen.be
...
if os.path.exists("/home/jmeester/Internship/CNV/sample_list.txt"):
        os.remove("/home/jmeester/Internship/CNV/sample_list.txt")
file_object=open("sample_list.txt", "a")
for line in countfiles:
        if line.endswith(".count.autosomal.norm"):
                print(line)
...
with open ("sample_list.txt", "r") as sample_list:
        for filename in sample_list:
                ...
                pbs_scriptname=sample + "_pbs_cnv.sh"
                with open(pbs_scriptname, "w") as pbs_file:
                        ...
                        pbs_file.write("#PBS -l mem=60gb \n")
                        pbs_file.write("#PBS -l walltime=48:00:00 \n")
                        pbs_file.write("#PBS -N cnv_analysis \n")
                        ...
                        pbs_file.write("/opt/software/miniconda_rnaseq/bin/Rscript /home/jmeester/Internship/Scripts/CNV.Calling.R " + filename + " " + sample + " " + output_dir)
			pbs_file.write("\n")
